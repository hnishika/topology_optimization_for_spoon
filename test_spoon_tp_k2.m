...
% test_spoon_tp_k2.m
%
% Model exported on Jul 7 2025, 18:09 by COMSOL 6.3.0.290.
...
model.modelPath('E:\hnishika\2025\Project\03_Topology_Optimization\02_work\250617\test_spoon_tp_k2\result');

model.label('result0050.mph');

model.param.set('maxitr', '50');
model.param.set('g1max', '2000');
...
model.opt.objective.remove('integral3');
model.opt.objective.remove('integral4');
...
model.result('pg1').feature('vol1').set('resolution', 'custom');
model.result('pg1').feature('vol1').set('refine', 2);
model.result('pg1').feature('vol1').feature('def').set('scale', 0.008025264310661147);
